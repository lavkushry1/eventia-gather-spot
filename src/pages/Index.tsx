...
const TestimonialsSection = () => {
  const testimonials = [
    ...
    },
    {
      ...
      name: 'David Chen',
      role: 'Music Fan',
      content: "I have been using Eventia to discover and book concerts for over a year now. The experience is seamless, and I love the personalized recommendations.",
